...
**Every wakeup, before anything else:**

1. Does today's memory file exist?
2. Is it NEW vs yesterday's content?
3. Check latest session log — Validation: PASS or FAIL?
4. If FAIL or MISSING: Alert immediately, fix before anything else
