...
- [ ] Roger writes first draft of Role Cards → shared memory
- [ ] Scout adds technical constraints
- [ ] Iris adds validation gates
- [ ] Hermes adds handoff protocols
- [ ] 4-way review → finalize v0.1
